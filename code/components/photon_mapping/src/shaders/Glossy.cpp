...
{
    Glossy::Glossy(Material& material, vector<Texture>& textures)
    ...
    Scattered Glossy::shade(const Ray& ray, const Vec3& hitPoint, const Vec3& normal) const {
